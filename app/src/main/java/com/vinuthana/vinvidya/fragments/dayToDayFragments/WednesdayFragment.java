...
public class WednesdayFragment extends Fragment {
    TextView tvTimeTableClsDispWed;
    ...
    private void initialization() {
        tvTimeTableClsDispWed = (TextView) getActivity().findViewById(R.id.tvTimeTableClsDispWed);
        ...
        tvTimeTableClsDispWed.setText(strClass);
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
           ...
           /* try {
                ...
                tvTimeTableClsDispWed.setText(strClasSection);
            } catch (Exception e) {
                e.printStackTrace();
            }*/
        }
