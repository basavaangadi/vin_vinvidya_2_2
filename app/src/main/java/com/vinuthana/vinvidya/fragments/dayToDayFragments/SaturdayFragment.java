...
public class SaturdayFragment extends Fragment {
    TextView tvTimeTableClsDispSat;
    ...
    public void initialization() {
        tvTimeTableClsDispSat = (TextView) getActivity().findViewById(R.id.tvTimeTableClsDispSat);
        ...
        tvTimeTableClsDispSat.setText(strClass);
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            //tvCurNoticeStudentName.setText("Student Name : "+values[0].getString("StudentName"));
            /*try {
                ...
                tvTimeTableClsDispSat.setText(strClasSection);
            } catch (Exception e) {
                e.printStackTrace();
            }*/
