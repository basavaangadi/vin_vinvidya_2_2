...
public class ThursdayFragment extends Fragment {
    TextView tvTimeTableClsDispThu;
    ...
    private void initalization() {
        tvTimeTableClsDispThu = (TextView) getActivity().findViewById(R.id.tvTimeTableClsDispThu);
        ...
        tvTimeTableClsDispThu.setText(strClass);
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            /*try {
                ...
                tvTimeTableClsDispThu.setText(strClasSection);
            } catch (Exception e) {
                e.printStackTrace();
            }*/
        }
