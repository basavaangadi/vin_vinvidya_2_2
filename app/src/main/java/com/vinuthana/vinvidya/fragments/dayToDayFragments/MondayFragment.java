...
public class MondayFragment extends Fragment {
    TextView tvTimeTableClsDispMon;
    ...
    public void initialization() {
        tvTimeTableClsDispMon = (TextView) getActivity().findViewById(R.id.tvTimeTableClsDispMon);
        recyclerViewMon = (RecyclerView) getActivity().findViewById(R.id.recyclerViewMon);
        ...
        tvTimeTableClsDispMon.setText(strClass);
    ...
    private class GetTimeTable extends AsyncTask<String, JSONArray, Void> {
        ...
        protected void onProgressUpdate(JSONArray... values) {
            ...
            /*try {
                ...
                tvTimeTableClsDispMon.setText(strClasSection);
            } catch (Exception e) {
                e.printStackTrace();
            }*/
        }
