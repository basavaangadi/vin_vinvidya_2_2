...
public class ChapterSpinnerDataAdapter extends BaseAdapter {

    LayoutInflater layoutInflater;
    JSONArray array;
    Context context;

    public ChapterSpinnerDataAdapter(JSONArray array, Context context) {
        this.array = array;
    ...
    public Object getItem(int position) {
        try {
            return array.getJSONObject(position).getString(context.getString(R.string.key_Subject));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
