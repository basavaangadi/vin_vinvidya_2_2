...
public class SyllabusAdapter extends RecyclerView.Adapter<SyllabusAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(SyllabusAdapter.MyViewHolder holder, int position) {
        try {
            ...
            // holder.tvSylbsSubject.setText("Subject: " +strSubject);
            ...
            holder.crdviewSyllabus.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    try {
                        if (!syllabusListnter.equals(null)) {
                            JSONObject object= sylbsArray.getJSONObject(position);
                            Log.e("OnSy","sylb Clciked");
                            syllabusListnter.onSyllabusClick(object,position);
                        }
                    }catch (Exception e)
                    {
