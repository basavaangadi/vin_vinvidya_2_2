...
public class FeesDetailsRecyclerViewAdapter  extends  RecyclerView.Adapter<FeesDetailsRecyclerViewAdapter.MyViewHolder> {
    JSONArray jsonArray;
    Context mContext;
    String strFeesType;
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tvDate,tvChallanNum,tvClass,tvRollNum,tvStudName,tvPaid,tvTotalAmt,tvBalAmt;
    ...
    public FeesDetailsRecyclerViewAdapter(JSONArray jsonArray, Context context, String strFeesType)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fees_list,parent,false);
