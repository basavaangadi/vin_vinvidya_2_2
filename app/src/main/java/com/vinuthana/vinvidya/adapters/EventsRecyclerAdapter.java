...
public class EventsRecyclerAdapter extends RecyclerView.Adapter<EventsRecyclerAdapter.MyViewHolder> {
    ...
    public EventsRecyclerAdapter(JSONArray eventsArray, Activity activity,String studentId ) {
    ...
    class EventsDescription extends AsyncTask<String, JSONArray, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            try {
                ...
                outObject.put(activity.getString(R.string.key_OperationName), activity.getString(R.string.web_getEventDetails));
                JSONObject otherData = new JSONObject();
                otherData.put(activity.getString(R.string.key_studentId), strStudentId);
