...
public class GalleryCatAdapter extends BaseAdapter {
    ...
    public Object getItem(int position) {
        try {
            return array.getJSONObject(position).getString(context.getString(R.string.key_eventTitle));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            viewHolder.tView_cate_name.setText(jsonObject.getString(context.getString(R.string.key_eventTitle)));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return convertView;
